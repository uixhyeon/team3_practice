    ...
    // 관리자 페이지  (사이드바 레이아웃 적용)
    {
      ...
      children: [
        ...
        },
        {
          ...
          component: () =>
            import("../pages/admin/ReservationManagementView.vue"),
    ...
    // 기사 페이지 ===================================
    {
      ...
      children: [
        ...
        },
        {
          ...
          meta: { title: "일정", role: "worker" },
        },
        {
          path: "payment",
          name: "WorkerPayment",
          component: () => import("../pages/worker/Payment.vue"),
          meta: { title: "정산", role: "worker" },
        },
        {
          path: "edit-profile",
        ...
        },
        {
          path: "profile",
          name: "WorkerProfile",
          component: () => import("../components/worker/WorkerProfile.vue"),
          meta: { title: "마이페이지", role: "worker" },
        },
      ],
    },
